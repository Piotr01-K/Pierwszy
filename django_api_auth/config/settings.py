...
SECRET_KEY = 'django-insecure-k!ms_u+4&w#-#(!@5qyd=^meedjruv75pn12czoie#868=$ong'
...
INSTALLED_APPS = [
    ...
    'django_celery_beat',   #  dodane lesson 29 task 4
]
...
MIDDLEWARE = [
    ...
    'config.middleware.PrintMethodMiddleware',  #   lesson 26 task 7
]
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=10),  # zmienione task 9 lesson 26
